...
export const metadata: Metadata = {
  title: "Ukraine Information Hub - Facts & Updates",
  description: "Get factual information about the situation in Ukraine, humanitarian impact, and ways to support. Verified sources and credible updates.",
  keywords: "Ukraine, crisis, humanitarian, news, situation, support, information",
  metadataBase: new URL("https://ukraine-info-hub.com"),
  alternates: {
    canonical: "https://ukraine-info-hub.com"
  },
  openGraph: {
    title: "Ukraine Information Hub - Stay Informed",
    description: "Understanding the situation in Ukraine with factual information and resources",
    siteName: "Ukraine Info Hub",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766152804606-n71b1awh.jpg",
      alt: "Ukraine situation"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Ukraine Information Hub",
    description: "Factual information about the situation in Ukraine",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766152804606-n71b1awh.jpg"]
  },
  robots: {
    index: true,
    follow: true
